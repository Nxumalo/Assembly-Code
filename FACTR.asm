...
;                                  Program Calculating Factorials

;                Muizenberg Cape Town South Africa, 20 May 2021

; This is a sample of an assembler 
; program which calculates the function called n-factorial 
...
ExCycle:                      ;This label marks end of program                        
      mov ax,4C00h            ;AH register contains 4Ch code that 
                              ;is a Dos Function number,AL register contains return code 00
